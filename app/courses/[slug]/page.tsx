...
const courses: Course[] = [
  {
    ...
    description:
      "Learn to recite the Quran with proper Tajweed rules and pronunciation. This comprehensive course covers all aspects of Quranic recitation from basic to advanced levels.",
    type: "free",
    price: null,
    rating: 4.8,
    review_count: 156,
    ...
    modules: [
      {
        ...
        items: [
          ...
          {
            id: "2",
            title: "History of Tajweed",
            type: "video",
            order_index: 2,
          },
          {
            id: "3",
            title: "Quiz: Tajweed Basics",
            type: "quiz",
            order_index: 3,
          },
        ],
    ...
    reviews: [
      {
        ...
        rating: 5,
        comment:
          "Excellent course! The instructor explains everything clearly and the pace is perfect for beginners.",
                          ...
                          >
                            <div className="flex items-center justify-between mb-3">
                              ...
                              <div className="flex items-center gap-2 text-sm text-gray-600">
                                <Clock className="h-4 w-4" />
                                <span>
                                  {formatDuration(module.estimated_time)}
                                </span>
                              </div>
                            </div>
                            {module.description && (
